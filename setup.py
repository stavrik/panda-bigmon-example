#!/usr/bin/env python
#
# Setup prog for bigpandamon-example
#
#
...
setup(
    name=__provides__,
    version=__version__,
    description='BigPanDA Monitoring Package - Example',
    long_description='''This package contains BigPanDA Monitoring project example''',
    license='GPL',
    author='Panda Team',
    author_email='hn-example-panda-pathena@cern.ch',
    ...
    data_files=[ #FIXME
                # config files 
                ('%sexample/settings' % (lib_prefix), [
                            'example/settings/local.py-example-template', ]
                 ),
